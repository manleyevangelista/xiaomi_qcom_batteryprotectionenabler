# Xiaomi Battery Protection Pseudo-Backport for Older Qualcomm-based Xiaomi/Redmi/POCO Phones and Tablets
...
<img src="https://github.com/manleyevangelista/xiaomi_batteryprotection_pseudo_backport_qcom/blob/main/images/BatteryProtectionSettings.jpg" style="width:400px;">
...
If unplugged or not charging, the value should be `0`.

If it's charging, the value should briefly switch between `0` and `1` once every minute.

You should see the live value change as the condition change (eg. when the device is unplugged/plugged in).
